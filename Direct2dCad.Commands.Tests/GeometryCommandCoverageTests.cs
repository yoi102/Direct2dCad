...
public sealed class GeometryCommandCoverageTests
{
    ...
    public void ScalarGeometryCommands_ExecuteAndUndoRestorePreviousGeometry()
    {
        ...
        var ellipseArc = document.AddEllipseArc(new CadPointD(4, 5), 6, 3, 0.1, 1.25);
        ...
        Assert.Equal(0.1, ellipseArc.StartAngleRadians);
        Assert.Equal(1.25, ellipseArc.SweepAngleRadians);
    }
